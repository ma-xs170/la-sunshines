...
export default async function SupportHistoryPage({ searchParams }: { searchParams: Promise<Record<string, string | string[] | undefined>> }) {
  ...
  return (
    <main className="org org-page">
      <div className="org-head"><div><h1 className="org-head__title">Historique du support</h1><p className="script">{current.name}</p></div><a className="btn btn--amber btn--lg" href="/organisateur/support/nouveau">Créer un ticket</a></div>
