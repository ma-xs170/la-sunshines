...
const FAQ: { q: string; a: string; cap?: 'manage' | 'owner' }[] = [
  ...
  { q: 'Puis-je modifier un tarif déjà vendu ?', a: 'Tu peux changer son prix et ses dates, mais pas descendre la quantité sous le nombre de billets vendus ou en cours de paiement. Un tarif vendu ne se supprime pas : il est archivé, et les billets déjà émis restent valables. Un tarif peut être gratuit (0 €) ; sinon le prix minimum est de 0,50 € (limite de Stripe).', cap: 'manage' },
