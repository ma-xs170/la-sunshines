  ...
  return (
    <main className="org org-page">
      ...
      <section className="glass ef-card">
        ...
        <p>Le staff scanne ce QR code avec son téléphone : il arrive sur la connexion, puis directement sur le scanner de l’évènement. <strong>Chaque personne se connecte avec son propre compte</strong> (rôle « Staff » à donner dans <a href="/organisateur/organisation/membres">Membres et rôles</a>) : ce QR ne donne aucun accès à lui seul.</p>
