    ...
    <>
      ...
      <div className="ef">
        <section className="glass ef-card"><h2>Mon compte administrateur</h2>
          ...
          <div className="ef-row"><Link className="btn btn--outline" href="/compte">Mon compte et mot de passe</Link></div>
        </section>
        <section className="glass ef-card"><h2>Réglages de la plateforme</h2>
          ...
          <div className="ef-row"><Link className="btn btn--amber" href="/admin/billetterie">Mode et frais de billetterie</Link><Link className="btn btn--outline" href="/admin/contenu">Contenu du site</Link></div>
        </section>
