...
export function eventMenu(slug: string): MenuGroup[] {
  ...
  return [
    ...
    { id: 'ev-event', label: 'Évènement', icon: 'sparkles', items: [
      { label: 'Description', cap: 'manage' }, { label: 'Décliner le flyer', cap: 'manage' }, { label: 'Lieux', cap: 'manage' }, { label: 'Sessions', cap: 'manage' },
      { label: 'Formulaires', cap: 'manage' }, { label: 'Lineup', cap: 'manage' }, { label: 'Conditions générales', cap: 'manage' }, { label: 'Consentements RGPD', cap: 'manage' },
    ] },
